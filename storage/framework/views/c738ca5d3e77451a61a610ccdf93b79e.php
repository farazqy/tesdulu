        ...
        <div class="w-full md:w-1/2 bg-white flex flex-col justify-center items-center px-8 md:px-16 overflow-y-auto">
            <div class="w-full max-w-md py-10">
                ...
                <div class="flex justify-center mb-6">
                    <a href="/">
                        <img src="<?php echo e(asset('images/LOGO-M.png')); ?>" class="h-14 w-auto" alt="Logo">
                    </a>
                </div>
...
<?php endif; ?>
                    ...
                    <div class="mt-6 text-center text-sm text-gray-500">
                        Sudah punya akun? 
                        <a href="<?php echo e(route('login')); ?>" class="text-red-700 font-bold hover:underline">Login disini</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH C:\Users\faris\Downloads\TUBES PAW\SistemRuangan\resources\views/auth/register.blade.php ENDPATH**/ ?>
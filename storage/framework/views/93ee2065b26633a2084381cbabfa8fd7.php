    ...
    <div class="bg-red-900 pt-8 pb-24 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            ...
            <p class="text-red-100 mt-2 text-lg">
                <?php echo e(now()->isoFormat('dddd, D MMMM Y')); ?> — Pantau penggunaan ruangan secara real-time.
            </p>
        </div>
    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            ?>
                            <tr class="hover:bg-red-50/30 transition <?php echo e($isOngoing ? 'bg-red-50/20' : ''); ?>">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-bold text-gray-900"><?php echo e($start->format('H:i')); ?></div>
                                    <div class="text-xs text-gray-500">s/d <?php echo e($end->format('H:i')); ?></div>
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($schedule->purpose); ?></div>
                                </td>

                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <?php if($schedule->user->role === 'admin'): ?>
                                        ...
                                        <?php else: ?>
                                            <div class="h-6 w-6 rounded-full bg-gray-200 flex items-center justify-center text-xs font-bold text-gray-600 mr-2">
                                                <?php echo e(substr($schedule->user->name, 0, 1)); ?>

                                            </div>
                                            <span class="text-sm text-gray-600"><?php echo e($schedule->user->name); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </td>
...
<?php endif; ?><?php /**PATH C:\Users\faris\Downloads\TUBES PAW\SistemRuangan\resources\views/bookings/daily.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title>E-Ticket Booking - <?php echo e($booking->room->name); ?></title>
    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-2xl overflow-hidden ticket-container relative">
        ...
        <div class="px-8 py-8 space-y-6">
            ...
            <div class="text-center">
                ...
                <p class="text-4xl font-extrabold text-gray-900 mt-1"><?php echo e($booking->room->name); ?></p>
            ...
            <div class="grid grid-cols-2 gap-6 text-sm">
                <div>
                    ...
                    <p class="font-bold text-gray-800"><?php echo e(\Carbon\Carbon::parse($booking->start_time)->isoFormat('D MMMM Y')); ?></p>
                </div>
                ...
                <div class="text-right">
                    ...
                    <p class="font-mono font-bold text-gray-800">#<?php echo e(str_pad($booking->id, 6, '0', STR_PAD_LEFT)); ?></p>
                </div>
            </div>
            ...
            <div class="bg-gray-50 p-4 rounded-xl border border-gray-100 text-center">
                ...
                <p class="text-gray-800 font-medium text-sm italic">"<?php echo e($booking->purpose); ?>"</p>
            </div>
            ...
            <div class="text-center">
                <div class="h-12 bg-gray-800 w-full rounded-md flex items-center justify-center overflow-hidden">
                    <div class="flex space-x-1 h-full w-full justify-center opacity-50 px-4 py-2">
                        <?php for($i=0; $i<40; $i++): ?>
                            <div class="w-1 bg-white h-full" style="opacity: <?php echo e(rand(3,10)/10); ?>"></div>
                        <?php endfor; ?>
                    </div>
                </div>
        ...
        <div class="bg-gray-50 px-8 py-4 border-t border-gray-100 flex justify-between items-center no-print">
            <a href="<?php echo e(route('bookings.index')); ?>" class="text-gray-500 hover:text-gray-900 text-sm font-bold">
                &larr; Kembali
            </a>
...
</html><?php /**PATH C:\Users\faris\Downloads\TUBES PAW\SistemRuangan\resources\views/bookings/ticket.blade.php ENDPATH**/ ?>
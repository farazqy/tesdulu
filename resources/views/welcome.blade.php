    ...
    <body class="antialiased bg-white text-gray-800">
        ...
        <nav class="flex items-center justify-between px-8 py-4 bg-red-900 shadow-md sticky top-0 z-50">
            ...
            <div class="flex items-center space-x-4">
                @if (Route::has('login'))
                    @auth
                        <a href="{{ url('/dashboard') }}" class="px-5 py-2 text-sm font-bold text-red-900 bg-white rounded-full hover:bg-gray-100 transition shadow-sm">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="text-sm font-medium text-gray-200 hover:text-white">Log in</a>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="px-4 py-2 text-sm text-white bg-black/30 border border-white/20 rounded-full hover:bg-black transition">Register</a>
                        @endif
                    @endauth
                @endif
            </div>
        ...
        <div class="bg-white py-10 border-b border-gray-100 shadow-sm relative z-20 -mt-8 mx-6 rounded-lg md:mx-auto md:max-w-6xl">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div>
                    <p class="text-3xl font-bold text-red-900">{{ \App\Models\Room::count() }}</p>
                ...
                <div>
                    <p class="text-3xl font-bold text-red-900">{{ \App\Models\User::count() }}</p>
        ...
        <div id="rooms" class="bg-white py-20">
            <div class="max-w-7xl mx-auto px-6">
                <div class="flex justify-between items-end mb-12">
                    ...
                    <a href="{{ route('rooms.index') }}" class="hidden md:flex items-center text-red-700 font-bold hover:text-red-900 transition">
                        Lihat Semua Ruangan 
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="group bg-white border border-gray-100 rounded-2xl overflow-hidden hover:shadow-lg transition duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-gray-500 text-sm line-clamp-2 mb-4">{{ $room->facilities }}</p>
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-50">
                                ...
                                @endif
                                <a href="{{ route('bookings.create') }}" class="text-sm font-bold text-red-700 hover:text-red-900">Pinjam Sekarang &rarr;</a>
                            </div>
                        </div>
                    </div>
                    @empty
        ...
        <div id="schedule" class="bg-gray-50 py-20">
            <div class="max-w-7xl mx-auto px-6">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-500 mt-2">{{ \Carbon\Carbon::now()->locale('id')->isoFormat('dddd, D MMMM Y') }}</p>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="p-4 text-blue-600 font-bold">{{ $schedule->room->name }}</td>
                            <td class="p-4 text-gray-600">{{ $schedule->purpose }}</td>
                            <td class="p-4">
                ...
                <div class="mt-6 text-center">
                    <a href="{{ route('bookings.daily') }}" class="text-red-700 font-bold hover:underline text-sm">
    ...
    <div id="contact" class="bg-white py-20 border-t border-gray-100">
        ...
        <footer class="bg-gray-900 text-white pt-12 pb-8">
            ...
            <div class="text-center text-gray-600 text-sm pt-8 border-t border-gray-800">
                <p>© {{ date('Y') }} ROMENA | Telkom University. All rights reserved.</p>
            </div>
        </footer>
